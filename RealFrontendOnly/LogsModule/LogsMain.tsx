...
import SidebarLogs from '../../src/components/SidebarLogs';
import type { StatData } from '../LogsModule/LogsStatsSection'; 
...
import LogsStatsSection from '../LogsModule/LogsStatsSection';
import {
  InventoryIcon,
  TaskIcon,
  IncidentIcon,
