      ...
      <div className="flex flex-col items-center px-6 pb-6 -mt-10">
        ...
        {!isEditing ? (
          <button
            ...
            className="mt-5 w-full flex items-center justify-center gap-2 bg-[#072821] hover:bg-[#051f1a] text-white text-sm font-medium py-2.5 rounded-xl transition-colors duration-150"
          >
            <svg
              className="w-4 h-4"
              fill="none"
          ...
          <button
            onClick={onEditToggle}
            className="mt-5 w-full flex items-center justify-center gap-2 bg-gray-300 hover:bg-gray-400 text-[#374151] text-sm font-medium py-2.5 rounded-xl transition-colors duration-150"
          >
            <svg
              className="w-4 h-4"
              fill="none"
