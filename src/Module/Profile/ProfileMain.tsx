...
// Empty placeholder data - Replace with API calls to your backend
              ...
              {isEditing && (
                <div className="flex gap-2">
                  <button
                    ...
                    className="bg-[#072821] hover:bg-[#051f1a] text-white text-sm font-medium px-4 py-1.5 rounded-lg transition-colors"
                  >
                    Save
                  </button>
                  <button
                ...
                {(
                  ...
                  <div key={name}>
                    ...
                    <input
                      ...
                      className="w-full border border-[#d1d5db] rounded-lg px-3 py-2 text-sm text-[#111827] focus:outline-none focus:ring-2 focus:ring-[#1a3a30] focus:border-transparent"
                    />
                  </div>
                ))}
              </div>
...
interface InfoFieldProps {
  label: string;
  value: string;
  icon?: "user" | "phone" | "shield" | "calendar";
}
