          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            {role === 'admin' && (
              <button
                ...
                className="bg-white border border-gray-200 text-gray-800 hover:bg-gray-50 px-5 py-3 rounded-[16px] text-[14px] font-bold flex items-center gap-2.5 transition-all shadow-sm active:scale-95 cursor-pointer dark:bg-slate-950 hover:bg-slate-600 dark:border-slate-600"
              >
