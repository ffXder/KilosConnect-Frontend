...
const DashboardReplacementRecommendations: React.FC<DashboardReplacementRecommendationsProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 mt-6 dark:bg-slate-950 transition-colors duration-300 dark:border-slate-600">
      {/* Header */}
