...
const ProfileStatsSection: React.FC<{ stats: PerformanceStats }> = ({ stats }) => {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-[#e5e7eb]">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 xl:grid-cols-4 gap-2 sm:gap-3 md:gap-4 mb-6">
        {/* Maintenance Tasks */}
        <div className="bg-[#f0fdf4] border border-[#bbf7d0] rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 flex flex-col justify-between">
