    ...
    <div className="flex min-h-screen bg-[#F8FAFC] font-sans">
      ...
      <main className="flex-1 ml-[240px] p-10 overflow-y-auto">
        <header className="flex justify-between items-start mb-8">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Incident Reporting</h2>
            <p className="text-gray-500 mt-1">Track and manage equipment issues and safety hazards</p>
          </div>
        </header>
