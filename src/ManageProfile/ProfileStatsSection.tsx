...
const StatRow: React.FC<StatRowProps> = ({ label, sublabel, value }) => (
  <div className="flex items-center justify-between py-3 border-b border-[#f3f4f6] last:border-0">
    ...
    <span className="[font-family:'Poppins',Helvetica] font-semibold text-2xl text-[#1a4d3e] leading-none">
      {value}
    </span>
  </div>
);
...
const ProfileStatsSection: React.FC<ProfileStatsSectionProps> = ({ stats }) => {
  return (
    <div className="bg-white rounded-[16px] border border-[#e8e8e8] shadow-sm px-6 py-5">
      <h2 className="[font-family:'Poppins',Helvetica] font-semibold text-[#1a1a1a] text-xl mb-2 m-0 p-0">
        Performance Stats
      </h2>
